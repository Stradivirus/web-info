...
const ImageModal: React.FC<ImageModalProps> = ({ isOpen, onClose, images, currentIndex, setCurrentIndex }) => {
  useEffect(() => {
...
const StudyAccordion: React.FC<StudyAccordionProps> = ({ title, date, category, isOpen, onToggle, children }) => {
