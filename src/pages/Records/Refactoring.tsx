...
const refactoringCommit: string = getRecordsImage('refactoring.png');
const refactoringCommit2: string = getRecordsImage('refactoring2.png');
        ...
        <div className="flex gap-8">
          <div className="flex-1">
            <p className="mb-2 text-base text-gray-800">
              Portfolio 리팩토링<br />총 18개 파일이 변경되었으며, 컴포넌트와 데이터의 분리를 통해 889줄이 추가되고 2077줄이 제거되었습니다.
            </p>
          ...
          <div className="flex-1">
            <p className="mb-2 text-base text-gray-800">
              Exam_serverless 리팩토링<br /> 총 15개 파일이 변경되었으며, 공통 컴포넌트 분리를 통해 796줄이 추가되고 1171줄이 제거되었습니다.
            </p>
            <div className="rounded-lg overflow-hidden border border-gray-200">
              <img 
