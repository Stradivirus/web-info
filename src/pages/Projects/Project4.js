  ...
  return (
    <div className="project4-container">
          ...
          <div className="project4-content-box">
            ...
            <div className="project4-content-section">
              ...
              <p>
                ...
                Node.js는 데이터 저장과 API 처리를, Django는 Admin 페이지를 통한 데이터 조회만을 담당하게 하여<br></br>
                각 프레임워크의 장점을 살릴 수 있었습니다.<br></br>
                Node.js의 경우 빠른 API 개발과 유연한 기능 구현이 가능했고,<br></br>
                Django는 별도의 관리자 페이지 제작을 통해 데이터를 효과적으로 조회하고 관리할 수 있었습니다.<br></br>
                또한 Docker를 활용한 컨테이너화 덕분에 두 서버의 배포와 관리가 수월했으며,<br></br>
      ...
      <div className="project4-links">
        <a 
          href="https://github.com/stradivirus/reservation"
