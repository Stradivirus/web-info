          ...
          <div className="p-8">
            ...
            <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
              <p className="font-medium">
                안녕하세요! 풀스택 개발자이자 빅데이터 엔지니어를 꿈꾸며 성장하고 있는 문성종입니다.
              </p>
              <div className="space-y-2">
                <p>
                  최신 웹·서버 기술들을 활용해서 프론트엔드부터 백엔드, 데이터 파이프라인까지 직접 만들어보며 경험을 쌓아왔습니다.
                </p>
                <p>
                  자동화된 CI/CD 파이프라인을 구축하고 운영하면서 개발과 배포 과정을 더 효율적으로 만드는 일에 재미를 느꼈습니다.
                </p>
                <p>
                  데이터 수집부터 가공, 분석, 시각화까지 자동화하는 빅데이터 프로젝트들을 통해 대용량 데이터를 다루는 실력을 기르고 있습니다.
                </p>
                <p>
